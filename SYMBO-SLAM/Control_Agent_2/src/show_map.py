...
class show_map:
    ...
    def show_map_main(self, m_p_global_map, class_name_map, oracle, landmark_map, images_path):
        try:
            ...
            color_map = {"bushland": "green", "desert": "yellow", "forest": "green", "marine": "blue", "beach": "yellow", "freshwater": "blue", "suburban": "blue", "city": "orange", "town": "orange", "industrial": "brown", "military": "red", "park": "purple"}
            if(oracle == "T"):
                m_s.lock.acquire()
